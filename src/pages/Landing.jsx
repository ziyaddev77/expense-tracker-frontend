    ...
    <div className='h-screen bg-white flex items-center justify-center'>
        <div className="w-full max-w-95 text-center">
            <div className="text-center">
                <span className="p-2 inline-block rounded-md bg-main"><Wallet className="fill-gray-200 text-transparent" size={40}/></span>
                <h1 className="text-2xl font-semibold text-main">Mizaniya</h1>
